...
function felExport() {
    ...
    var fel = {
        "heatsynced": { /* legacy Fire Branded */
            ...
            "image": "https://raw.githubusercontent.com/Krazete/sgmprocessor/master/image_processing/output/stanley/an/hSync.png",
    ...
    for (var vid in variants) {
        ...
        var value = {
            ...
            "image": "https://raw.githubusercontent.com/Krazete/sgmprocessor/master/image_processing/output/stanley/" + variant.base + "/" + vid + ".png",
